...
| `PORT-ARTIFACT`  | Artifact persistence            | `X-STORE`                                                                                                                 | Immutable evidence, configuration-artifact, and terminal audit-export writes, owner-authorized disposal, plus digest-verified reads.                                                                                                                                                                                                                |
