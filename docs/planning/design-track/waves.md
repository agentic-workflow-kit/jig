...
| 6    | [`wave-6-implementation-phasing/`](./waves/wave-6-implementation-phasing/README.md) | `1`, `2`, `3`, `4a`, `4b`, `5` | `w6-s1`                            | Planning-track implementation-phasing handoff only; no `docs/design/**` targets                                                            | Sequences delivery phases and gates; does not re-own U9 collection or contract mutation.                                 |
...
| 6    | Settled scaffold                                                                                | U9 must keep Wave 6 as a handoff artifact, not a design doc or delivery tracker.                    |
