...
product intent — *who Jig serves, what job it does, what it promises, and where its
boundaries are* — and is the contract the design and delivery layers reconcile to.
