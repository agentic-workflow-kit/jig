...
| Standalone deterministic orchestration proposal           | [`deterministic-story-orchestration/`](./deterministic-story-orchestration/)                                                                         | proposal    | separate reconciliation and adoption decision                                                                           |
