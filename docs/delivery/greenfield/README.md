...
| 3 — lifecycle and execution          | GF-030–039                                                     | lifecycle, bounds, workspace/session, Doorbell, obligations                                                                      | scripted intake-to-park path; GF-039 local workspace remains a non-configuring probe, deferred and unconfigurable pending independent evidence; no landing claim |
