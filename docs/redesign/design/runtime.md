...
| `PORT-ARTIFACT`  | Artifact persistence            | `X-STORE`                                                                                                                 | Immutable evidence and terminal audit-export artifact writes, owner-authorized disposal, plus digest-verified reads.                                                                                                                                                                                                                                |
