...
| `PC-JIG-8`      | `CF-BINDING` pass + `CF-PROVIDER-AUTHORITY` pass + `CF-SECRET-ABSENCE` pass                                               |
...
| `PC-CONCEPTS-3` | `CF-BINDING` pass + `CF-PROVIDER-AUTHORITY` pass + `CF-SECRET-ABSENCE` pass                                               |
