...
| `PC-JIG-1`      | `CF-RUN-CONTROL` pass + `CF-NOTICE-EXPORT` pass + `CF-OBSERVABILITY` pass                                                                                                                                           |
...
| `PC-CONCEPTS-8` | `CF-RUN-CONTROL` pass + `CF-OBSERVABILITY` pass                                                                                                                                                                     |
| `PC-CONCEPTS-9` | `CF-ENVELOPE` pass + `CF-CAPACITY` pass                                                                                                                                                                             |
