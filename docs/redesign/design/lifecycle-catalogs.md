...
stateDiagram-v2
    ...
    Finalizing --> Reviewing: EV-OWNER-DECISION, closes exact invalidating park; release authority, invalidate acceptance, and create fresh RP-PACKAGE
    ...
    note right of Waiting
        ...
        releases held finalization authority, and requires a fresh complete
