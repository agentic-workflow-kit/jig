...
- **ADRs 0026–0028 carry no `- Date:` line.** Every ADR from 0001–0025 has one; 0026–0028 do not.
  Rather than invent a date, the Date column is left blank for those three. Whether to add a
  `- Date:` line to 0026–0028 (and, if so, what date to use — authoring date vs. merge date) is a
