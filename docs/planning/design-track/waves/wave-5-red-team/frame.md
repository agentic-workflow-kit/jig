...
| [`../../session-template.md`](../../session-template.md)                                                                                                                                                                                                              | authoritative — method/template                     | The standard frame/charter/story structure this wave follows, including the two-story scaffold under the red-team charter                                                                            | Template source only; does not establish domain ownership                                                                             |
| [`../wave-4b-providers/decisions.md`](../wave-4b-providers/decisions.md) + [`../wave-4b-providers/stories/w4-s6-execution-host-provider.md`](../wave-4b-providers/stories/w4-s6-execution-host-provider.md)                                                           | authoritative — prior-wave ownership carry-forward  | The SEC-2 three-way split: `w4-s6` owns design posture/proof seed, Wave 5 owns the full adversarial scenario, and U9 later collects the posture and probe routing                                    | Prior-wave sources define the split; they do not themselves author the Wave 5 probes                                                  |
...
| ---------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------ | --------------- |
| **Artifact scope for this pass:** does Wave 5 create only a frame, or also charter/stories/decisions?                              | The committed Wave 5 directory shape, [`../../session-template.md`](../../session-template.md), and the current charter/story scaffold all separate the frame intake step from later charter/story authoring                                           | **provided** — create only `frame.md`; do not author charter, stories, `decisions.md`, or any integration docs                                                                                                                                    | Current file scope and downstream coordinator work                       | approved        |
| **Wave purpose:** is Wave 5 design-authoring or stress/probe-only?                                                                 | [`../../README.md`](../../README.md), [`../wave-4b-providers/README.md`](../wave-4b-providers/README.md), and Wave 4b's SEC-2 carry-forward sources all describe Wave 5 as a red-team wave that stresses settled design and introduces no new entities | **provided** — Wave 5 is a stress/probe wave only; any gaps become findings, contradiction checks, or routed questions, never new design ownership                                                                                                | Governs the whole wave and prevents design-creep                         | approved        |
...
| **Story split inside Wave 5:** how should the two future stories divide work without inventing new entities?                       | The current frame scope plus the prior-wave seams show authority/provider issues clustering around `w4-s3` + Wave 4b, while recovery/records issues cluster around `w2-s2` + `w4-s1` + `w4-s4` + the records contract                                  | **safe assumption** — `w5-s1` probes authority/provider/SEC-2 contradictions; `w5-s2` probes recovery/records/bootstrap integration contradictions. This is the only narrow split consistent with the existing story IDs and prior-wave ownership | Later story authoring and charter story order                            | not required    |
...
| **Where do Wave 5 findings land?**                                                                                                 | The track dependency rule, STOP-003 posture in prior waves, and Wave 4b's SEC-2 carry-forward sources all forbid product/design re-litigation inside this wave                                                                                         | **provided** — findings route back to the owning wave/design/product doc as open questions, contradiction notes, or U9 collection items; Wave 5 does not resolve them locally                                                                     | Governs finding routing and prevents local override of settled design    | approved        |
...
| Both probe surfaces                        | route findings to              | Existing design/product owners and U9 collector            | Wave 5 identifies gaps; it does not resolve them locally                                                        |
| U9 collector                               | collects                       | `w4-s6` SEC-2 posture + Wave 5 phone-home findings         | Integration-owned; not authored by Wave 5                                                                       |
...
| **U9 collector (integration-owned)**          | Integration-level collection of red-team scope/routing alongside the Wave 4b SEC-2 posture                                                                                          | Wave 5 outputs and `w4-s6` posture                                                                                               | Performing the Wave 5 adversarial work itself                                     | U9 owns collection after Wave 5; it does not invent Wave 5 findings |
...
- **Delivery constraints to preserve:** keep the wave light and red-team-only; do not introduce new
  ...
  to existing owners or U9 collection; keep product IDs, `INV-*`, and M5a handoff
