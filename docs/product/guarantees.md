---
title: "Jig — the five guarantees (detail)"
status: draft — guarantees detail
---

# The five guarantees — in detail

This is the full, ID-bearing specification behind Jig's
[five guarantees](./jig.md#the-five-guarantees). Product owns these outcome-level commitments
and their IDs; design owns how they are implemented and verified. For the overview, the product
