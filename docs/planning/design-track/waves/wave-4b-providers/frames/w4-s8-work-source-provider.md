...
| `/Users/aryekogan/.claude/plans/enumerated-kindling-raccoon.md`                                                      | authoritative — governing plan                                 | The planning-track provider boundary and Wave 4 split: providers consume core contracts read-only, and the validated plan remains jig's hard input boundary                                                                                                                                                                                                                                                | Portable authority for the full Wave 4b boundary wording this frame applies                                                                                                                                              |
...
| `/Users/aryekogan/.claude/plans/enumerated-kindling-raccoon.md` | The governing plan's provider-boundary rule and plan-as-hard-input posture for Wave 4b                                                         |
