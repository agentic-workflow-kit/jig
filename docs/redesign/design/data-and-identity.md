...
| `SCH-DECISION`           | Human/operator decision                  | Exact Run, parked-request, Story, notice, or `ID-OBLIGATION` subject; decision kind and reason; responder identity; for a non-owner, current `ID-GRANT`; exact request binding where applicable; scoped permission/question answer, continuation, reject-story, suspend, resume, terminal stop, acknowledgement, snooze, or obligation resolution with evidence. Provider answers grant no Jig Operation and cannot change posture.                                                                                                                                                                                                           |
