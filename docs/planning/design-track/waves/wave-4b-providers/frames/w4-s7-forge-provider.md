...
| `/Users/aryekogan/.claude/plans/enumerated-kindling-raccoon.md`                                                        | authoritative — governing plan                                 | The planning-track provider boundary for Wave 4b: providers implement against ports and consume core contracts read-only                                                                                                                                                                                                                                                                              | Portable authority for the full Wave 4b boundary wording this frame applies                                                                                                                                                  |
...
| `/Users/aryekogan/.claude/plans/enumerated-kindling-raccoon.md` | The governing plan's provider-boundary rule for Wave 4b                                                             |
