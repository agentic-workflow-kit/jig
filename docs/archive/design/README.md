---
title: Jig — design (archived)
status: historical archive — superseded by docs/redesign/design/
---

# Jig — design (archived)

> **Archived 2026-07-16 by explicit owner decision.** The live design layer is
> [`docs/redesign/design/`](../../redesign/design/README.md) — the approved layered architecture
> (Layer 0 brief; Layer 1 approved and locked; Layer 2 approved, not locked). This tree is
> preserved as provenance: it is the pre-redesign engineering reference the current
> implementation and the active delivery phases were authored against, and it remains the
> operative citation target for the v0 data contracts, the ADR log, and committed evidence
> records until those seams are reconciled into the redesign. Do not extend it with new design
> work. One exception: the active delivery track continues to append dated evidence records
> under [`evidence/`](./evidence/README.md) per the evidence convention until the redesign
> defines their new home.

This tree holds Jig's pre-redesign **engineering design**: the implementation reference for
_how_ the product commitments in [`docs/product/`](../../product) are satisfied. Product owns
_what_ and _why_; design owns _how_ and reconciles to product — where they conflict, design
names it rather than silently resolving.
...
[planning design track](../planning/design-track/README.md). That record is preserved for
