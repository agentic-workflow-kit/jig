...
| [`../../HANDOFF.md`](../../HANDOFF.md)                                                                      | authoritative — continuation runbook                            | Wave 6 is a light frame, story ID `w6-s1-implementation-phasing`, and follows Wave 5 before U9                                                                                       | Commit inventory earlier in the handoff predates Wave 5's final commit, so live git history must be checked                                  |
| `/Users/aryekogan/.claude/plans/enumerated-kindling-raccoon.md`                                             | authoritative — governing plan                                  | Wave list, story ID, framing method, and the rule that Waves 5-6 use a light frame because they sequence/stress rather than introduce new entities                                   | External local source; governs scope but not repo-local wording                                                                              |
| `/Users/aryekogan/.codex/attachments/988f1259-87d6-45e5-a852-467e967a351a/pasted-text.txt`                  | authoritative — user brief                                      | Current-pass constraints: frame only; no charter or story yet; no new entities; no tracker; keep product IDs, `INV-*`, and M5a categories distinct                                   | External local input, not a repo artifact                                                                                                    |
...
| -------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------- | --------------- |
| **Artifact scope for this pass:** does Wave 6 create only a frame, or also charter/stories/decisions?    | User brief and pasted text explicitly limit this pass to `docs/planning/design-track/waves/wave-6-implementation-phasing/frame.md` only; track method and handoff separate later authoring                       | **provided** — create only `frame.md`; do not author charter, story, `decisions.md`, or any integration docs                                                                                                                                           | Current file scope and downstream coordinator work                                              | approved        |
| **Wave purpose:** is Wave 6 implementation design, implementation sequencing, or a delivery tracker?     | Track README, handoff, governing plan, and user brief all describe Wave 6 as implementation phasing and a handoff to a future delivery track, not code or tracker execution                                      | **provided** — Wave 6 sequences settled design into implementation-ready phases only; it does not author code, delivery tickets, or runtime implementation artifacts                                                                                   | Governs every section of the frame and the future story's boundaries                            | approved        |
...
| **Does Wave 6 own contract edits, invariant numbering, or U9 collection work?**                          | User brief forbids product re-litigation and new ID invention; track README and handoff reserve `traceability.md`, `review-and-red-team.md`, and U9 collection for integration                                   | **provided** — no contract mutation, no hard-numbered new invariants, no U9 collection work here. Phase sequencing cites those later obligations read-only                                                                                             | Preserves namespace discipline and avoids stealing U9's ownership                               | approved        |
...
| Source                                              | Establishes                                                                                               |
| --------------------------------------------------- | --------------------------------------------------------------------------------------------------------- |
| Track README, handoff, and governing plan           | Wave 6's file scope, light-frame posture, and delivery-handoff purpose                                    |
...
None. The wave's scope, lightness, and handoff posture are directly provided by source. The phase
...
| -------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------- |
| **Implementation sequencing surface**  | Define the phase order that turns the settled design into implementation-ready slices without reopening design ownership                                                  | The phase ordering logic, dependency rationale, and delivery-handoff posture for `w6-s1`                      | Track charter, handoff, prior-wave frames/stories, M5a delivery inputs                                      | Code, tracker rows, contract edits, or package structure decisions                      |
