...
| Arye                           | Authorize, Decide                           | Product and architecture imports/approval, gate verdicts, layer reopens, policy/authority exceptions, named escalations, Run control, and operational choices.  | Routine implementation, verification, delivery, or implicit ambient intervention.                                                           |
| Recorded per-Run delegate      | Authorize, Decide                           | Only bounded operational classes and subjects named by a current `ID-GRANT`, including decide/answer, Run stop/resume, notice, and similar operational choices. | Product/architecture imports or approval, gate verdicts, layer reopens, subdelegation, expired/revoked/escaped scope, or ambient authority. |
...
| Work Source mechanism          | Propose, Observe, Attest                    | Pre-Run request/revision-bound candidate work and provenance through `PORT-SOURCE`.                                                                             | Intake, lifecycle, evidence sufficiency, or active-Run authority.                                                                           |
...
| First-party consumer adapters  | Route, Observe                              | Authenticated CLI/private-MCP/SDK calls through `PORT-CONSUMER` and validated durable views.                                                                    | Synthesizing authority or calling controller components, stores, or mechanisms directly.                                                    |
