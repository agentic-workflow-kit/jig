...
| `CF-DELEGATION`       | A delegated decision requires a current, unrevoked, in-scope `ID-GRANT`; invalid issuer authority, expired, revoked, superseded, implicitly subdelegated, or escaped scope is rejected as `FC-AUTHORITY`.   | I2, I3, I7, I20 |
