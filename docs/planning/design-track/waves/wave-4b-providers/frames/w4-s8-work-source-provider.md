...
| [`../../README.md`](../../README.md) + [`../README.md`](../README.md) + [`../decisions.md`](../decisions.md)         | authoritative — track charter + wave charter/decision log      | The planning-track provider boundary and Wave 4 split: providers consume core contracts read-only, and the validated plan remains jig's hard input boundary                                                                                                                                                                                                                                                | Durable repo-local authority for the full Wave 4b boundary wording this frame applies                                                                                                                                    |
| [`../decisions.md`](../decisions.md)                                                                                 | authoritative — wave decision log                              | D-004 adopts that provider boundary for this wave and fixes the Work source provider's ownership posture                                                                                                                                                                                                                                                                                                   | Wave-local authority for the specific Wave 4b boundary wording this part carries                                                                                                                                         |
| [`AGENTS.md`](../../../../../AGENTS.md) (jig repo root)                                                              | authoritative — repo contract/context                          | Repo-level guardrails, including jig's one-hard-input posture and house conventions                                                                                                                                                                                                                                                                                                                        | Important context, but not the sole authority for the full Wave 4b provider-boundary wording                                                                                                                             |
...
| `../../README.md`, `../README.md`, `../decisions.md`      | The durable repo-local provider-boundary rule and plan-as-hard-input posture for Wave 4b                                                       |
| `../decisions.md`                                         | D-004's Wave 4b boundary-rule adoption                                                                                                         |
| `AGENTS.md`                                               | Repo-contract context and the plan-as-one-hard-input guardrail                                                                                 |
