...
| `RT-EVIDENCE`   | Immutable artifact store  | Data store   | Holds bounded evidence and configuration artifacts, the artifact-backed records governed by `LG-PREFLIGHT-ATTEMPT`, plus terminal audit exports. Preflight-attempt records are immutable mechanism evidence only; the `LG-INTAKE` terminal acknowledgement remains the sole intake authority.                                                                                                                                                                                                                                                                                          |
