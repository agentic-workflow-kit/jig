...
| `SCH-INTAKE-ACK`         | Durable intake acknowledgement           | Envelope composition digest as the sole submission identity, its proposal digest and bound owner-approval record, `ID-RUN`, accepted/rejected preflight disposition and reason, acknowledgement digest, and conditional-create or digest-lookup proof. An accepted acknowledgement also embeds the canonical frozen `SCH-ENVELOPE` bytes, including its explicit `successorLineage` or `absent` genesis value, and complete Run-ledger genesis/rebuild basis; recovery needs no mutable or separately authoritative input. Same-digest readback is byte-equivalent.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
