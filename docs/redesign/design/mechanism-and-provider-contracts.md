...
| `active`                  | Context is lost but replacement is allowed for the same principal/assignment                                | `replaced`, then terminal; record successor `ID-SESSION`. The successor separately enters `open`.    |
