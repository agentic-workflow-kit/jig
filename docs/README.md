...
It plans delivery only; it does not authorize product source or product scaffolding. Each story
still starts only after verified merged predecessor evidence and its exact provider/`DR-*` gates.
