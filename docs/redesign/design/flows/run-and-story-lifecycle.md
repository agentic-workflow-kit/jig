...
| **Completed**                | Every Story has a final business outcome and every Retirement duty is complete or represented by an exact Residual Obligation with status `accepted-handoff`.                                                                                  | Terminal durable Run result; later obligation resolution is post-terminal administration and does not revise these facts.                                                                                                                                                                                              |
...
accepted-handoff obligation resolution, and owner-authorized evidence disposal. They cannot alter any Run
...
| Residual Obligation resolution          | `EV-OBLIGATION-RESOLVED` | Exact live obligation status is `accepted-handoff`; completion criteria and digest-verified evidence pass; append terminal `resolved` status while retaining the obligation identity and prior Run/Story facts. |
...
| `Completed`                 | `Settling` at the terminal-settlement position                      | Only the settlement-authorized audit-export put and receipt/failure, accepted-handoff obligation resolution, and owner-authorized evidence disposal. None may change phase, Story state, outcome, authority, or dependency. |
