...
| Layer 1 — high-level architecture | All Layer 1 pages in the document map, the decision records, and the invariants         | D1, D2, and D4–D9 remain locked; the bounded owner-approved D3 amendment is pending renewed exact-candidate review                              |
