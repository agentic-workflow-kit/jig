...
| **Candidate**           | One exact committed Story result, carried only by `SCH-CANDIDATE` and bound to its target basis, evidence, and delivery metadata.                                                                                                                    |
| **Accepted**            | Jig's durable lifecycle decision after valid reviewer approval of the exact `SCH-CANDIDATE` and Jig's structural, identity, authority, evidence, findings, and lifecycle validation.                                                                 |
