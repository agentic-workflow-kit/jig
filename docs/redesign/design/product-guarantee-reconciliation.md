...
| `PC-JIG-14`     | `CF-CONSUMER` pass + Governance: runtime/D10 private-facade and no-public-stability records hold                                                                                                                    |
...
| `PC-CONCEPTS-4` | `CF-CONSUMER` pass + Governance: runtime/D10 private-facade and no-public-stability records hold                                                                                                                    |
...
| `PC-USE-3`      | `CF-POLICY` pass + `CF-PROVIDER-AUTHORITY` pass + Governance: `EP-PROFILE` authority limit holds                                                                                                                    |
