...
| Suite               | Port             | Gates                                                                                                                                                                                                                                         |
| ------------------- | ---------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `CF-MECH-LEDGER`    | `PORT-LEDGER`    | Conditional-append rejection, durable acknowledgement, both confirmed-absent sub-cases of unknown-ack resolution, and `LG-WITNESS` currency: independent trust, monotonicity, advance-before-acknowledgement, and rollback-restore detection. |
